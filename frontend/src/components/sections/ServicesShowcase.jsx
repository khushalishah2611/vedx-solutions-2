...
import { Box, Button, ButtonBase, Grid, Paper, Stack, Typography, alpha } from '@mui/material';
  ...
  return (
    <Stack spacing={4} id="services">
      <Stack spacing={1.5} alignItems="center" textAlign="center">
        <Typography variant="h3" sx={{ fontSize: { xs: 32, md: 44 }, lineHeight: 1.1, fontWeight: 700 }}>
          {heading}
        </Typography>
      </Stack>
              ...
              return (
                <Grid item xs={12} sm={4} key={service.title}>
                  ...
                  >
                    ...
                    <Stack
                      spacing={1}
                      sx={{ position: 'relative', p: 3, height: '100%', justifyContent: 'flex-end' }}
                    >
        ...
        <Grid item xs={12} md={6}>
          <Paper
            sx={{
              ...
              p: { xs: 3, md: 5 },
              background: 'linear-gradient(135deg, rgba(32,7,76,0.92) 0%, rgba(5,9,18,0.95) 75%)',
          ...
          >
            ...
            <Box
              sx={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(160deg, rgba(5,9,18,0.35) 20%, rgba(5,9,18,0.9) 100%)'
              }}
            />
            <Stack spacing={3} sx={{ position: 'relative' }}>
              <Stack spacing={1}>
                <Typography
                  variant="h4"
                  sx={{ fontSize: { xs: 28, md: 36 }, fontWeight: 700, color: 'common.white' }}
                >
                  {activeService.title}
                </Typography>
