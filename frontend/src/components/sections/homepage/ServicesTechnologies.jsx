import { Avatar, Box, Tab, Tabs, Grid, Paper, Stack, Typography, alpha, useTheme } from '@mui/material';
...
const ServicesTechnologies = () => {
  ...
  const technologies = useMemo(() => technologyTabs[activeTab]?.technologies ?? [], [activeTab]);
    ...
    <Box component="section">
      <Stack spacing={3} alignItems="center" textAlign="center" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: subtleText, maxWidth: 760 }}>
          Choose from a comprehensive library of frontend, backend, database, and DevOps expertise to ship resilient platforms.
        </Typography>
      </Stack>
            ...
            <Paper
              ...
              sx={{
                ...
                '&:hover': {
                  ...
                  boxShadow: isDark
                    ? '0 26px 45px rgba(103,232,249,0.18)'
                    : '0 26px 45px rgba(59,130,246,0.16)'
                }
              }}
            >
              <Avatar
