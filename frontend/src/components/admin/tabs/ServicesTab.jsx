    ...
    <CardContent>
      ...
      >
        ...
        <TextField
          ...
          InputProps={{
            endAdornment: (
              <SelectClearAdornment visible={Boolean(categoryFilter)} onClear={() => setCategoryFilter('')} />
            ),
          }}
          sx={{ minWidth: 220 }}
        >
        ...
        {serviceDateFilter === 'custom' && (
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} flex={1}>
            <TextField
              ...
              onChange={(event) => setServiceDateRange((prev) => ({ ...prev, start: event.target.value }))}
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={1} display="flex" alignItems="flex-end">
                          <Stack direction="row" spacing={1} justifyContent="flex-end">
                            ...
                            <Tooltip title="Edit">
                              <IconButton size="small" color="primary" onClick={() => openServiceEditDialog(service)}>
                                <EditOutlinedIcon fontSize="small" />
                              </IconButton>
                            </Tooltip>

                            <Tooltip title="Delete">
                              <IconButton size="small" color="error" onClick={() => openServiceDeleteDialog(service)}>
