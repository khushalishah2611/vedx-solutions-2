...
const AdminDashboardPage = () => {
  ...
  const loadWhyVedxReasons = async () => {
    try {
      ...
      const res = await fetch(apiUrl("/api/home/why-vedx-reasons"), { headers });
      const data = await res.json();
  ...
  const handleWhyVedxReasonSubmit = async () => {
    try {
      ...
      const url = editingWhyVedxReasonId
        ? apiUrl(`/api/home/why-vedx-reasons/${editingWhyVedxReasonId}`)
        : apiUrl("/api/home/why-vedx-reasons");
  ...
  const handleConfirmDeleteWhyVedxReason = async () => {
    ...
    try {
      const headers = getAdminAuthHeaders();
      const res = await fetch(
        apiUrl(`/api/home/why-vedx-reasons/${whyVedxReasonPendingDelete.id}`),
        {
          method: "DELETE",
          headers,
        }
