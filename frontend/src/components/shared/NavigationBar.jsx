        ...
        slotProps={{
          paper: {
            ...
            sx: {
              ...
              py: 0,
              borderRadius: 3,
              background: 'linear-gradient(135deg, rgba(34,9,78,0.96) 0%, rgba(5,9,18,0.96) 100%)',
              border: '1px solid rgba(103, 232, 249, 0.35)',
              boxShadow: '0 28px 60px rgba(8, 12, 32, 0.6)',
                ...
                return (
                  <ButtonBase
                    ...
                    sx={{
                      ...
                      border: '1px solid',
                      borderColor: active ? alpha('#67e8f9', 0.7) : 'rgba(255,255,255,0.08)',
                      backgroundColor: active
                        ? 'linear-gradient(135deg, rgba(103,232,249,0.25), rgba(103,232,249,0.05))'
                        : 'transparent',
          ...
          >
            ...
            <Box
              sx={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(140deg, rgba(10,14,35,0.65) 0%, rgba(10,12,32,0.9) 100%)',
                borderRadius: { xs: 0, md: 3 }
              }}
            />
  ...
  return (
    <AppBar
      ...
      sx={{
        ...
        background: 'linear-gradient(90deg, rgba(34,9,78,0.88) 0%, rgba(9,14,35,0.88) 100%)',
        backdropFilter: 'blur(24px)',
        boxShadow: '0 12px 32px rgba(8, 12, 30, 0.45)'
      }}
    >
      ...
      <Drawer
        ...
        PaperProps={{
          sx: {
            background: 'linear-gradient(180deg, rgba(34,9,78,0.96) 0%, rgba(5,9,18,0.96) 100%)',
            color: 'common.white',
